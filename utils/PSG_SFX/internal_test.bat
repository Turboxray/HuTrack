...
python VGM2SFX.py --filein internal_test/smb3_overworld.vgm --debugLog --waveformlist internal_test/main.wf.inc --destfolder internal_test/smb3_overworld --chanproc 0 1 2 3 4 5 --debugBin
...
@REM python VGM2SFX.py --filein internal_test/SCV4_SimonTheme.vgm --debugLog --waveformlist internal_test/main.wf.inc --destfolder internal_test/SCV4_SimonTheme --chanproc 0 1 2 3 4 5 --debugBin
